...
private void initComponents() {
        ...
        monde.getPaysParNom("Argentina").setPolygon(Argentina);
        listePays.add(Argentina);
		...
		monde.getPaysParNom("CAmerica").setPolygon(CAmerica);
        listePays.add(CAmerica);
        ...
        monde.getPaysParNom("Mexico").setPolygon(Mexico);
        listePays.add(Mexico);
        ...
        monde.getPaysParNom("USA").setPolygon(USA);
        listePays.add(USA);
        ...
        monde.getPaysParNom("Madagascar").setPolygon(Madagascar);
        ...
        monde.getPaysParNom("Equateur").setPolygon(Equateur);
        ...
        monde.getPaysParNom("Canada").setPolygon(Canada);
        ...
        monde.getPaysParNom("Spain").setPolygon(Spain);
	    listePays.add(Spain);
        ...
        monde.getPaysParNom("France").setPolygon(France);
        ...
        monde.getPaysParNom("UK").setPolygon(UK);
	    listePays.add(UK);
        ...
        monde.getPaysParNom("Italy").setPolygon(Italy);
	    listePays.add(Italy);
        ...
        monde.getPaysParNom("Sahel").setPolygon(Sahel);
	    listePays.add(Sahel);
        ...
        monde.getPaysParNom("Ethiopia").setPolygon(Ethiopia);
	    listePays.add(Ethiopia);
        ...
        monde.getPaysParNom("Congo").setPolygon(Congo);
	    listePays.add(Congo);
        ...
        monde.getPaysParNom("Arabia").setPolygon(Arabia);
	    listePays.add(Arabia);
        ...
        monde.getPaysParNom("India").setPolygon(India);
        listePays.add(India);
        ...
        monde.getPaysParNom("China").setPolygon(China);
        listePays.add(China);
        ...
        monde.getPaysParNom("Australia").setPolygon(Australia);
        listePays.add(Australia);
        ...
        monde.getPaysParNom("Indonesia").setPolygon(Indonesia);
        listePays.add(Indonesia);

        int xCenterEurope [] = {637,636,635,637,645,648,650,654,658,662,667,670,673,676,678,679,682,684,686,690,690,701,706,706,709,713,713,720,722,724,721,722,727,732,736,739,742,743,743,741,741,743,744,745,744,747,748,751,752,758,762,762,768,769,756,750,744,743,738,734,728,723,721,719,719,719,718,714,714,711,709,708,707,709,711,709,706,705,702,700,697,695,691,688,686,685,685,682,681,679,678,673,672,669,665,664,662,661,658,656,651,651,649,648,647,644,644,641,638,638};
        int yCenterEurope [] = {256,259,260,263,266,266,278,278,284,281,277,277,276,276,277,277,280,284,283,288,290,298,300,304,312,315,317,318,316,316,311,308,307,307,307,307,305,304,301,300,297,294,292,288,287,286,282,280,276,278,279,282,274,263,260,257,249,243,235,226,220,217,214,213,215,218,219,217,214,215,218,219,224,228,230,232,232,231,232,233,232,232,232,235,235,237,237,237,236,234,234,235,234,232,233,238,239,239,239,238,241,241,244,246,247,248,250,253,255,259};
        ...
        monde.getPaysParNom("Russia").setPolygon(Russia);
        listePays.add(Russia);
        ...
        monde.getPaysParNom("Greenland").setPolygon(Greenland);
        listePays.add(Greenland);
        ...
        Turkey = new Polygon(xTurkey, yTurkey, xTurkey.length);
        monde.getPaysParNom("Turkey").setPolygon(Turkey);
	    listePays.add(Turkey);
